        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card-block text-left">
              <h4 class="card-title"><?= $skillElement["name"] ?></h4>
              <form class="form-inline my-auto" method="GET" action="<?= $skillElement['page']?>">
          ...
          <div class="col-md-6">
            <img class="card-img-top rounded mx-auto d-block img-thubnail img-fluid" src='<?= $skillElement["imgPath"] ?>' alt="<?= $skillElement["name"] ?>">
          </div>
        </div>
      </div>
    </div>
